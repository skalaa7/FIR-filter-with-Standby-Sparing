...
HD_PWD='C:/Users/Andrej/Desktop/git/otporni/fault_tolerant_fir/fault_tolerant_fir.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fault_tolerant.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fault_tolerant.tcl
