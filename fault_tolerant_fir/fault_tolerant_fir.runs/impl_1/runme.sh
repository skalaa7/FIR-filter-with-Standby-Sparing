...
HD_PWD='C:/Users/Andrej/Desktop/git/otporni/fault_tolerant_fir/fault_tolerant_fir.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fault_tolerant.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fault_tolerant.tcl -notrace
