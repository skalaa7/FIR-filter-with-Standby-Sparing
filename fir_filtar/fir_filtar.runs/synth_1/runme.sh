...
HD_PWD='C:/Users/Andrej/Desktop/git/otporni/fir_filtar/fir_filtar.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_filtar.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_filtar.tcl
