...
HD_PWD='C:/Users/Andrej/Desktop/git/otporni/fir_filtar/fir_filtar.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_filtar.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fir_filtar.tcl -notrace
